...
- Data have idiosyncrasies, so transformations easily adopt adhoc designs
  ...
  - Adhoc designs are costly to maintenance, collaborate on ...
  - 2x trouble if that design isn't your payload ("load that pays")
  - To be sure, design standards cost upfront time

- Standards save cognitive load, for spending on payload  
...
- In my Data Science experience:
  ...
  - Non-standard workflows are hard to maintain, extend
      - Does design enforce, modular & orthogonal components? 
      - For new reader (or future self), what's time-to-understanding?
